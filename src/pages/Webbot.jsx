...
import LogoBrandMonkey from "../assets/images/Recursos IMG/139.png";
...
const Webbot = () => {
  ...
  return (
    <div>
      ...
      <div className='text-center w-[680px] '>
        <p className="text-[23px] font-bold px-[30px] py-[20px] mx-[30px] rounded-lg">
                    Respuestas mas rapidas a las <br /> consultas de los usuarios, <br />
                    mejorando su experiencia
                    </p>
        <p className="text-[23px] font-bold px-[30px] py-[20px] mx-[30px] rounded-lg">
                    Disponible en todo momento, lo <br />
                    que permite atender consultas <br />
                    incluso fuera del horario laboral. 
        </p>
        <p className="text-[23px] font-bold px-[30px] py-[20px] mx-[30px] rounded-lg">
                    Automatiza tareas repetitivas <br />
                    ahorrando tiempo tanto a los <br />
                    usuarios como al equipo de<br /> 
                    atencion al cliente
        </p>
        </div>
          ...
          <div className='grid mt-8 ml-[20px] mr-[200px] justify-end w-[50%]'>
            <div>
              <div className='relative w-[600px] bg-[#FA96DE] m-[15px] rounded-lg'>
                ...
                <label htmlFor="input1" className='font-body1 text-white tracking-[1px] mx-[20px] h-[50px] flex items-center' onClick={() => expandirOpcion('input1')}>¿Que es exactamente este bot web? </label>
